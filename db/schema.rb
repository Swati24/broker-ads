...
ActiveRecord::Schema.define(version: 20180222185024) do
  ...
  create_table "ad_bases", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "ad_requests", force: :cascade do |t|
    ...
    t.integer  "daily_amount",     limit: 4,     default: 0
  end
